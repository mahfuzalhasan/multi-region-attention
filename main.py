...
if __name__ == '__main__':
    ...
    linear_scaled_lr = config.TRAIN.BASE_LR * config.DATASET.BATCH_SIZE * dist.get_world_size() / 512.0
    linear_scaled_warmup_lr = config.TRAIN.WARMUP_LR * config.DATASET.BATCH_SIZE * dist.get_world_size() / 512.0
    linear_scaled_min_lr = config.TRAIN.MIN_LR * config.DATASET.BATCH_SIZE * dist.get_world_size() / 512.0
    ...
    # config.freeze()
    print(config.TRAIN.BASE_LR, config.TRAIN.WARMUP_LR, config.TRAIN.MIN_LR)
